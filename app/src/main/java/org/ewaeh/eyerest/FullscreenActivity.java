...
//        });
        ...
        @SuppressLint("StringFormatMatches") String message = String.format(msgTemplate, String.format("%.1f", lockSetting.lockIntervalSeconds / 60.0), lockSetting.eyeLookAwayNum, lockSetting.restSeconds, lockSetting.countDownRefreshSecond);
